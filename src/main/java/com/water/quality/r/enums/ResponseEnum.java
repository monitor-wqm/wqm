...
public enum ResponseEnum {
    ...
    INSERT_DATA_ERROR(107, "数据新增失败"),
    TYPE_DATA_ERROR(108, "数据类型错误"),
    DATABASE_UPDATE_ERROR(109, "数据修改错误，请检查数据是否符合标准"),
    ...
    ID_REPEAT_ERROR(217, "ID重复"),
    MONITORPOINT_ID_NULL(218, "监测点id为空"),
    MONITORPOINT_NODE_NULL(219, "监测点节点为空"),
    PH_IS_NULL(220, "PH为空"),
    DISSOLVEDOXYGEN_IS_NULL(221, "溶氧量为空"),
    NH3N_IS_NULL(222, "氨氮为空"),
    MNO4_IS_NULL(223, "高猛酸盐为空"),
    CITY_DISTRICT_NULL(224, "市区为空"),
